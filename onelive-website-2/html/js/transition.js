...
var PageTransitions = (function () {
    ...
    function pageOverflows($pageTrigger){
        ...
        if ( gotoPage == 1) {
        	$(".pt-wrapper").find('.pt-page').addClass('no-overflow');
        	$("#backSlider").removeClass('backSliderOver');
        } else {
        	$(".pt-wrapper").find('.pt-page').removeClass('no-overflow');
        	$("#backSlider").addClass('backSliderOver');
        }
    }
